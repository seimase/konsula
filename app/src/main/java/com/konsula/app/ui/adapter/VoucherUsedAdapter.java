...
/**
 * Created by Konsula on 29/06/2016.
 */
public class VoucherUsedAdapter extends RecyclerView.Adapter<VoucherUsedAdapter.ViewHolder> {

    private int itemLayout;
    private Context mContext;
    List<MyVoucherModel.Used> mResources;


    public VoucherUsedAdapter(Context context, List<MyVoucherModel.Used> resource, int itemLayout) {
        mContext = context;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        final MyVoucherModel.Used item = mResources.get(position);
