 ...
 */
public class InitSearchDefaultDoctorAdapter extends ArrayAdapter<MultiSearchModel.Result> {

    public InitSearchDefaultDoctorAdapter(Context context) {
        super(context, 0);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.kategoriFilterTextView.setText((currentLanguage.equals("en") || currentLanguage.equals("EN")) ? getItem(position).english_name : getItem(position).bahasa_name);
